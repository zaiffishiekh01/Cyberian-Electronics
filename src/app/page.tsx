...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      {/* Hero Section */}
      <section className="relative isolate overflow-hidden bg-gradient-to-b from-blue-100 to-white dark:from-blue-900 dark:to-gray-900 pt-14">
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-blue-600 dark:text-blue-400">Advanced Technology</h2>
      ...
      <section className="bg-blue-50 dark:bg-blue-900 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Trusted by Industry Leaders</h2>
            <div className="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
              ...
              >
                ...
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-blue-600 dark:text-blue-400">{testimonials[currentIndex].author}</div>
                  <div className="mt-1 text-gray-500 dark:text-gray-400">{testimonials[currentIndex].role}</div>
                </figcaption>
              </motion.figure>
            </div>
          ...
          <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-16">
            <div>
              ...
              <p className="mt-4 text-gray-500 dark:text-gray-400">
                At Cyberian Electronics, we leverage advanced digital technologies to enhance business operations and foster growth. Our foundation is built on a deep understanding of both the challenges and opportunities within the tech industry, guided by seasoned professionals committed to excellence.
              </p>
              <p className="mt-4 text-gray-500 dark:text-gray-400">
                Our approach is client-focused, tailoring solutions to meet specific business needs. From strategic IT consulting to bespoke web development, we provide a range of services designed to optimize performance and drive success in a competitive digital landscape.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              ...
              <Image
                ...
                className="rounded-lg object-cover"
              />
              <div className="col-span-2 flex items-center justify-center bg-blue-600 rounded-lg p-8">
                <div className="text-center">
                  <p className="text-5xl font-bold text-white">09</p>
